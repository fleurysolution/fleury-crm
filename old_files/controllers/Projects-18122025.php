    ...
    public function save_captured_image()
{
    ...
    if ($imageData) {
        ...
        // Define storage path
        $target_path = get_setting("project_file_path"); // same as used for regular files
        if (!$target_path) {
        ...
        // Generate file name and save physical file
        $file_name = 'photo_' . time() . '.png';
        $file_path = $target_path .'/'.$project_id.'/'. $file_name;
        file_put_contents($file_path, $data);

        // Move file into system storage (if your app uses temp move logic)
        $file_info = [
            'file_name' => $file_name,
        ...
        if ($success) {
            // Save custom fields and trigger notifications
