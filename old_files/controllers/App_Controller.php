...
class App_Controller extends Controller {
    ...
    public $Estimate_materials_model;
    ...
    public $Material_categories_model;
    public $Material_area_model;
    ...
    public $Project_amendment_model;
    public $Package_price_model;
    ...
    public function __construct() {
        ...
        foreach ($settings as $setting) {
            config('Fs')->app_settings_array[$setting->setting_name] = $setting->setting_value;
        }
