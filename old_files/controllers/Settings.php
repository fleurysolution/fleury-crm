...
class Settings extends Security_Controller {
    ...
    function save_email_settings() {
        ...
        foreach ($settings as $setting) {
            ...
            $this->Settings_model->save_setting($setting, $value);
            //reload the configs
            config('Fs')->app_settings_array[$setting] = $value;
        }
    ...
    function branches(){
        ...
        $view_data['divisions'] = $this->Settings_model->get_divisions();        
        $view_data['offices'] = $this->Settings_model->get_offices();
    ...
    function model_division(){
        $view_data['regions'] = $this->Settings_model->get_regions();        
        $view_data['divisions'] = $this->Settings_model->get_divisions();        
        $view_data['offices'] = $this->Settings_model->get_offices();
        return $this->template->rander("settings/branch/model-division", $view_data);
    }

    function model_region(){
        $view_data['regions'] = $this->Settings_model->get_regions();
        return $this->template->rander("settings/branch/model-region", $view_data);
    }

    function model_branch(){
        $view_data['regions'] = $this->Settings_model->get_regions();
        return $this->template->rander("settings/branch/model-branch", $view_data);
    }
     // ===== REGIONS =====
    ...
    function save_region() {
        ...
        $this->Settings_model->save_region($data, $id);
        echo json_encode(['success' => true, 'message' => 'Region saved successfully']);
    }

    function delete_region($id) {
        $this->Settings_model->delete_region($id);
        echo json_encode(['success' => true, 'message' => 'Region deleted']);
    }

    // ===== OFFICES =====
    function get_offices_by_region($region_id) {
        echo json_encode($this->Settings_model->get_offices($region_id));
    }
    ...
    function save_office() {
        ...
        $this->Settings_model->save_office($data, $id);
        echo json_encode(['success' => true, 'message' => 'Office saved successfully']);
       
        $this->session->setFlashdata("success_message", app_lang("Office saved successfully"));
        //app_redirect("settings/branches");
    }

    function delete_office($id) {
        $this->Settings_model->delete_office($id);
        echo json_encode(['success' => true, 'message' => 'Office deleted']);
    }

    // ===== DIVISIONS =====
    function get_divisions_by_office($office_id) {
        echo json_encode($this->Settings_model->get_divisions($office_id));
    }
    ...
    function save_division() {
        ...
        $this->Settings_model->save_division($data, $id);
        echo json_encode(['success' => true, 'message' => 'Division saved successfully']);
    }

    function delete_division($id) {
        $this->Settings_model->delete_division($id);
        echo json_encode(['success' => true, 'message' => 'Division deleted']);
    }

    public function get_office($id)
    {
        $office = $this->Settings_model->get_one($id);
