...
<div class="col-md-12 mb15">
    <?php if(!empty($all_versions)){ 
        ?>
         <div class="mb15"><strong><?php echo app_lang("version_details_list"); ?> </strong></div>
         <ul>
        <?php 
        foreach($all_versions as $versionData){ ?>
   <li> <p> <?php echo anchor(get_uri("contracts/view/" . $versionData->id), $versionData->title. ' (<strong>'.$versionData->version_number.'</strong>)'); ?>  </p></li>
