                            ...
                            <span class="dropdown inline-block mt15">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <?php if ($is_contract_editable) { ?>
                                        <li role="presentation"><?php echo modal_anchor(get_uri("contracts/modal_form"), "<i data-feather='edit' class='icon-16'></i> " . app_lang('ammend_contract'), array("title" => app_lang('ammend_contract'), "data-post-id" => $contract_info->id, "role" => "menuitem", "tabindex" => "-1", "class" => "dropdown-item")); ?> </li>
                                    <?php } ?>
