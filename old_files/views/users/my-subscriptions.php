<div class="tab-content">
    ...
    if(!empty($subscription_data)){
        $stripe_hosted_url= $subscription_data[0]->stripe_hosted_invoice_url;
    ?>
    <div class="card border-top-0 rounded-top-0">
        <div class=" card-header">
            ...
            $subscriptionbtn='clients/upgrade_subscription';
        ?></h4>
        </div>
        <div class="card-body">
        ...
        <div class=" card-header">
            ...
            <!-- <a href="<?php echo base_url($subscriptionbtn); ?>" class="btn button btn-primary"><?php echo app_lang("upgrade"); ?></a> -->
            <!-- <a href="<?php echo base_url($cancelbtn); ?>" class="btn button btn-primary"><?php echo app_lang("cancel"); ?></a> -->
             <a href="<?php echo $stripe_hosted_url; ?>" class="btn button btn-primary"><?php echo app_lang("view_details"); ?></a>
