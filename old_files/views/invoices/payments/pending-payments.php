<div class="card">
    <div class="tab-title clearfix">
        <h4> <?php echo app_lang('invoice_pending_payment_list'); ?> </h4>
    </div>
    <div class="table-responsive">
        <table id="invoice-pending-payment-table" class="display" cellspacing="0" width="100%">            
        </table>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#invoice-pending-payment-table").appTable({ 
            ...
            source: '<?php echo_uri("invoice_payments/pending_payment_list_data/" . $invoice_id) ?>',
            order: [[0, "asc"]],
            columns: [
                {targets: [0], visible: false, searchable: false},
                {visible: false, searchable: false},
                {title: '<?php echo app_lang("paid_by") ?> ', "class": "w15p all", "iDataSort": 1},
