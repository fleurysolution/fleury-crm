<?php echo form_open(get_uri("invoice_payments/save_payment_status"), array("id" => "invoice-approval-payment-form", "class" => "general-form", "role" => "form")); ?>
    ...
    <div class="container-fluid">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <?php
                        echo form_dropdown("invoice_id", $invoices_dropdown, "", "class='select2 validate-hidden' id='invoice_id' data-rule-required='true' readonly data-msg-required='" . app_lang('field_required') . "' ");
                        ?>
                    </div>
                </div>
            </div>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    echo form_dropdown("invoice_payment_method_id", $payment_methods_dropdown, array($model_info->payment_method_id ? $model_info->payment_method_id : get_cookie("user_" . $login_user->id . "_payment_method")), "class='select2 selected_payment_method' readonly" );
                    ?>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class=" col-md-9">
                    <p> <?php echo $model_info->note ? process_images_from_content($model_info->note, false) : ""; ?></p>
        ...
        <div class="form-group">
            <div class="row">
                <label for="invoice_payment_confirmation_note" class="col-md-3"><?php echo app_lang('confirmation_note'); ?></label>
                <div class=" col-md-9">
                    <?php
                    echo form_textarea(array(
                        "id" => "invoice_payment_confirmation_note",
                        "name" => "invoice_payment_confirmation_note",
                        "value" => $model_info->approval_note ? process_images_from_content($model_info->approval_note, false) : "",
                        "class" => "form-control",
                        "placeholder" => app_lang('approval_note'),
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#invoice-approval-payment-form").appForm({
