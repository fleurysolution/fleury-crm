<div id="page-content" class="page-wrapper clearfix">
    <div class="card clearfix">
        <ul id="payment-received-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white inner title" role="tablist">
            ...
            <li><a role="presentation" data-bs-toggle="tab" href="javascript:;" data-bs-target="#payments-list"><?php echo app_lang("approved_payments_list"); ?></a></li>
            <li><a role="presentation" data-bs-toggle="tab" href="javascript:;" data-bs-target="#pending-payments-list"><?php echo app_lang("pending_payments"); ?></a></li>
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade" id="pending-payments-list">
                <div class="table-responsive">
                    <table id="invoice-pending-payment-table" class="display" width="100%">
                    </table>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#invoice-payment-table").appTable({
            ...
            source: '<?php echo_uri("invoice_payments/approved_payment_list_data/") ?>',
            order: [[0, "asc"]],
...
<?php } ?>
            ...
            columns: [
                ...
                {title: '<?php echo app_lang("project_price") ?>', "class": "text-right w15p all"}
                ],
                summation: [{column: 6, dataType: 'currency', currencySymbol: AppHelper.settings.currencySymbol, conversionRate: <?php echo $conversion_rate; ?>}],
                printColumns: [0, 2, 3, 4, 5],
                xlsColumns: [0, 2, 3, 4, 5]
        });


        $("#invoice-pending-payment-table").appTable({
            source: '<?php echo_uri("invoice_payments/pending_payment_list_data/") ?>',
            order: [[0, "asc"]],
            smartFilterIdentity: "invoice_payments", //a to z and _ only. should be unique to avoid conflicts
            rangeRadioButtons: [{name: "range_radio_button", selectedOption: 'monthly', options: ['monthly', 'yearly', 'custom', 'dynamic'], dynamicRanges:['this_month', 'last_month', 'next_month', 'this_year', 'last_year']}],
            filterDropdown: [
