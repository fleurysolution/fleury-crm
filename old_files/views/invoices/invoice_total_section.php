<table id="invoice-item-table" class="table display dataTable text-right strong table-responsive">
    ...
    ?>
        ...
        <tr>
            <td><?php echo app_lang("balance_waiting_confirmation"); ?></td>
            <td><?php echo to_currency($invoice_total_summary->total_pending_confirmation_balance, $invoice_total_summary->currency_symbol); ?> </td>
            <?php if ($can_edit_invoices) { ?>
                <td></td>
            <?php } ?>
        </tr>
    ...
    <tr>
        <td><?php echo app_lang("project_price"); ?></td>
        <td><?php echo to_currency($invoice_total_summary->project_price, $invoice_total_summary->currency_symbol); ?></td>
        <?php if ($can_edit_invoices) { ?>
            <td></td>
        <?php } ?>
    </tr>
