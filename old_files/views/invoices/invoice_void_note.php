<?php echo form_open(get_uri("invoices/void_invoice_status"), array("id" => "void-note-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="form-group mt10">
            <div class="row">
                <div class="col-md-12">
                    <?php echo app_lang("void_note_message"); ?>
                </div>
            </div>
        </div>
