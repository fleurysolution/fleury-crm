<div style=" margin: auto;">
    ...
    if ($style === "style_3") {
        echo view('proposals/proposal_parts/header_style_3.php', $data);
    } else if ($style === "style_2") {
        echo view('proposals/proposal_parts/header_style_2.php', $data);
    } else {
        echo view('proposals/proposal_parts/header_style_1.php', $data);
    }
...
<?php if ($proposal_info->note) { ?>
    <br />
    <br />
    <div style="border-top: 1px solid #f2f4f6; color:#444; padding:0 0 20px 0;"><br /><?php echo nl2br(process_images_from_content($proposal_info->note)); ?></div>
...
<span style="color:#444; line-height: 14px;">
    <?php echo get_setting("proposal_footer"); ?>
</span>