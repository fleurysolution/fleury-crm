                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade" id="estimate-settings-tab">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="enable_estimate_lock_state" class="col-md-2"><?php echo app_lang('enable_lock_state'); ?> <span class="help" data-bs-toggle="tooltip" title="<?php echo app_lang('estimate_lock_state_description'); ?>"><i data-feather='help-circle' class="icon-16"></i></span></label>
                                    <div class="col-md-10">
                                        <?php
