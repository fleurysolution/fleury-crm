...
$settings_menu = array(
    "app_settings" => array(
        ...
        array("name" => "branches", "url" => "settings/branches"),
        array("name" => "regions", "url" => "settings/regions"),
        array("name" => "divisions", "url" => "settings/divisions"),
...
$settings_menu["sales_and_prospects"][] = array("name" => "material_categories", "url" => "material_categories");
