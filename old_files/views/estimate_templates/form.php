<div class="card">
    ...
    <?php echo form_open(get_uri("estimate_templates/save_template"), array("id" => "estimate-template-form", "class" => "general-form email-template-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#estimate-template-form").appForm({
            isModal: false,
