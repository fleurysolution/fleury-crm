<div class="modal-body clearfix" id="insert-template-section">
    <div class="container-fluid">
        <div class="form-group">
            <div class="row">
                <div class="col-md-12 text-off text-danger"> <?php echo app_lang('estimate_template_inserting_instruction'); ?></div>
            </div>
        </div>

        <div class="table-responsive">
            <table id="estimate-template-table" class="display no-thead clickable" cellspacing="0" width="100%">            
            </table>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#estimate-template-table").appTable({
            source: '<?php echo_uri("estimate_templates/list_data/modal") ?>',
            order: [[0, 'desc']],
            columns: [
        ...
        $customToolbar.find("label").addClass("estimate-template-label");
        $customToolbar.find("input").addClass("estimate-template-search");
    });
</script>