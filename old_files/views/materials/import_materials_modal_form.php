<?php echo form_open(get_uri("materials/save_item_from_excel_file"), array("id" => "import-item-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix import-item-modal-body">
    <div class="container-fluid">
        <div id="upload-area">
            <?php
            echo view("includes/multi_file_uploader", array(
                "upload_url" => get_uri("uploader/upload_excel_import_file"),
                "validation_url" => get_uri("materials/validate_import_materials_file"),
                "max_files" => 1,
...
<div class="modal-footer">
    <?php echo anchor("materials/download_sample_excel_file", "<i data-feather='download' class='icon-16'></i> " . app_lang("download_sample_file"), array("title" => app_lang("download_sample_file"), "class" => "btn btn-default float-start")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var $uploadArea = $("#upload-area"),
                ...
                $modalBody = $(".import-item-modal-body"),
        ...
        function addLargeModal() {
            $ajaxModal.addClass("import-item-app-modal");
        ...
        $submitButton.click(function () {
            $("#import-item-form").trigger("submit");
        });
        ...
        $nextButton.click(function () {
            ...
            appLoader.show({container: ".import-item-modal-body", css: "left:0;"});
            var $button = $(this);
            ...
            $.ajax({
                url: "<?php echo get_uri('materials/validate_import_materials_file_data') ?>",
                type: 'POST',
                dataType: 'json',
