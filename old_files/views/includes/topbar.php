    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav me-auto mb-lg-0">
                <li class="nav-item hidden-xs" title="<?php echo app_lang('menu'); ?>">
                    <a class="nav-link sidebar-toggle-btn" aria-current="page" href="#">
                        <i data-feather="menu" class="icon"></i>
                    </a>
                </li>

                <li class="nav-item d-block d-sm-none" title="<?php echo app_lang('dashboard'); ?>">
                    <?php
                    $user = $login_user->id;
            ...
            <div class="d-flex w-auto">
                <ul class="navbar-nav">
                    ...
                    if ($login_user->user_type == "staff") { ?>
                        ...
                        <li class="nav-item hidden-sm" title="<?php echo app_lang('titanmailbox'); ?>">
                            <a href="https://app.titan.email/login/" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-inbox icon"><polyline points="22 12 16 12 14 15 10 15 8 12 2 12"></polyline><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"></path></svg><?php echo app_lang('titanmailbox'); ?></a>
                        </li>
                    ...
                    <?php if (!in_array("language", $hidden_topbar_menus) && (($login_user->user_type == "staff" && !get_setting("disable_language_selector_for_team_members")) || ($login_user->user_type == "client" && !get_setting("disable_language_selector_for_clients")))) { ?>
                        ...
                        <li id="topbar-language-dropdown" class="nav-item dropdown hidden-xs" title="<?php echo app_lang('langugage'); ?>">
                    ...
                    <li class="nav-item dropdown" title="<?php echo app_lang('notifications'); ?>">
                    ...
                    <?php if (get_setting("module_message") && can_access_messages_module()) { ?>
                        <li class="nav-item dropdown hidden-sm <?php echo ($login_user->user_type === "client" && !get_setting("client_message_users")) ? "hide" : ""; ?>" title="<?php echo app_lang('messages'); ?>">
