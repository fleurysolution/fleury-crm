<div class="tab-content">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <p><?php echo app_lang('description') . ": " . $model_info->description; ?> </p>            
            <p><?php echo app_lang('Parent') . ": " ;
            $Roles_model = model('App\Models\Roles_model');
            $rolesData = $Roles_model->get_details(['id' => $model_info->parent_id])->getRow();
            echo $rolesData->title;?> </p>            
            <p><?php echo app_lang('hierarchy_level') . ": " . $model_info->hierarchy_level; ?> </p>
        </div>
        <div class="card-body">
            ...
            <ul class="permission-list">
                <li>
                    ...
                    <div id="project_permission_details_area" class="form-group <?php echo $do_not_show_projects ? "hide" : ""; ?>">
                        ...
                        <div id="individual_project_permission_area" class="<?php echo $can_manage_all_projects ? "hide" : ""; ?>">
                            ...
                            <div>
                                <?php
                                echo form_checkbox("can_assign_asset_on_projects", "1", $can_assign_asset_on_projects ? true : false, "id='can_assign_asset_on_projects' class='form-check-input'");
                                ?>
                                <label for="can_assign_asset_on_projects"><?php echo app_lang("can_assign_asset_on_projects"); ?></label>
                            </div>
                        </div>
                ...
                <?php
                try {
                    app_hooks()->do_action('app_hook_role_permissions_extension',$permissions);
                } catch (\Exception $ex) {
