                ...
                <div class="col-md-4">
                    <div id="role-list-box" class="card">
                        <div class="page-title clearfix">
                            ...
                            <div class="title-button-group">
                                <?php echo anchor(get_uri("roles/hierarchy_tree"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('hierarchy_tree'), array("class" => "btn btn-default", "title" => app_lang('hierarchy_tree'))); ?>
                            </div>
                        </div>
