<?php if (isset($page_type) && $page_type === "full") { ?>
    ...
    <div class="card rounded-top-0">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="page-title clearfix">
                         <h1><?php echo app_lang('pending_payments'); ?></h1> 
                    </div>
                </div> 
            <div class="col-sm-6">
                <div class="tab-title clearfix">
                   <a href="<?php echo_uri("invoice_payments/"); ?>" class="btn btn-warning"> <?php echo app_lang('approved_payments_list'); ?></a>
                </div>
            </div>
        </div>
        ...
        <?php } else { ?>
            ...
            <div class="tab-title clearfix">
                <h4><?php echo app_lang('pending_payments'); ?></h4>
            </div>
        <?php } ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#invoice-payment-table").appTable({
            source: '<?php echo_uri("invoice_payments/pending_payment_list_data_of_client/" . $client_id) ?>',
            order: [[1, "desc"]],
            columns: [
                ...
                {title: '<?php echo app_lang("project_price") ?>', "class": "text-right w15p"}
            ],
