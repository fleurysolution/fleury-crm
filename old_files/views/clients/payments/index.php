        ...
        <?php if (isset($page_type) && $page_type === "full") { ?>
            ...
            <div class="col-sm-6">
                <div class="tab-title clearfix">
                    <a href="<?php echo_uri("invoice_payments/pending_payments/"); ?>" class="btn btn-warning"> <?php echo app_lang('pending_payments'); ?></a>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#invoice-payment-table").appTable({
            source: '<?php echo_uri("invoice_payments/approved_payment_list_data_of_client/" . $client_id) ?>',
            order: [[1, "desc"]],
            columns: [
