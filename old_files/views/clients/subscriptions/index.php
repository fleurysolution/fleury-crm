    ...
    $(document).ready(function () {
        ...
        $("#subscription-table").appTable({
            ...
            columns: [
                ...
                {title: "Max Staff", "class": "w10p text-right"},
                {title: "Max Client", "class": "w10p text-right"},
                {title: "Invoice Limit", "class": "w10p text-right"},
                {title: "Project Limit", "class": "w10p text-right"},
                {title: "Storage Limit", "class": "w10p text-right"},
                {title: "Enhanced Reporting", "class": "w10p text-right"}
