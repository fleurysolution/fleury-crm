<?php print_r($project_dropdown); $project_dropdown=array(); if (isset($page_type) && $page_type === "full") { ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#invoice-table").appTable({
            source: '<?php echo_uri("invoices/active_invoice_list_data_of_client/" . $client_id) ?>',
            order: [[0, "desc"]],
            filterDropdown: [
               ...
               // {name: "project", class: "w150", options: <?php //echo $project_dropdown; ?>},
<?php echo $custom_field_filters; ?>],
            ...
            columns: [
                ...
                {title: "<?php echo app_lang("project") ?>", "class": "all w10p", "iDataSort": 0},
                {visible: false, searchable: false},
...
<?php echo $custom_field_headers; ?>
        ...
        $("#cancelled-invoice-table").appTable({
            source: '<?php echo_uri("invoices/cancelled_invoice_list_data_of_client/" . $client_id) ?>',
            order: [[0, "desc"]],
            filterDropdown: [
                {name: "type", class: "w150", options: <?php echo $types_dropdown; ?>},
                {name: "status", class: "w150", options: <?php echo view("invoices/invoice_statuses_dropdown"); ?>},
