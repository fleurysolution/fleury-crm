...
<div id="page-content" class="page-wrapper clearfix">
    ...
    <ul id="client-contact-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs b-b rounded-0 border-top-0" role="tablist">
        ...
        <?php if ($user_info->id == $login_user->id) { ?>
            ...
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("clients/my_subscription/" . $user_info->id); ?>" data-bs-target="#tab-my-subscription"> <?php echo app_lang('subscription'); ?></a></li>
        <?php } ?>
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade" id="tab-my-subscription"></div>
