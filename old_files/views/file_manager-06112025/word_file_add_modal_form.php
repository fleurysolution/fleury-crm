<?php echo form_open(get_uri("file_manager/save_word_file_add_modal_form"), array("id" => "word_file_form", "class" => "general-form", "role" => "form")); ?>
        ...
        <div id="file-upload-dropzone-scrollbar" class="ps" style="height: 280px; position: relative;">
            ...
            <div id="" class="box dz-complete">
                    ...
                    <div class="box-content">
                        <p class="name" data-dz-name=""><?php echo date('ymd-his').'-client.docx'; ?></p>
                        <p class="clearfix">
                            <span class="size float-start" data-dz-size=""><strong>12154</strong>B</span>
                ...
                <input type="hidden" name="file_name_1" value="<?php echo date('ymd-his').'-client.docx'; ?>">
                <input type="hidden" name="file_size_1" value="12154"></div></div>
        </div>
    </div>
</div>
    </div>
