...
<div id="page-content" class="page-wrapper clearfix">
    ...
    <ul id="team-member-view-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs rounded-0 border-top-0" role="tablist">
        ...
        <?php if ($show_timesheets) { ?>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("projects/all_timesheets/" . $user_info->id); ?>" data-bs-target="#tab-timesheets"> <?php echo app_lang('timesheets'); ?></a></li>
        <?php } ?>
        ...
        <?php } ?>
        <?php if ($show_attendance) { ?>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("team_members/team_availability/" . $user_info->id); ?>" data-bs-target="#tab-appointments-info"><?php echo app_lang('appointment_info'); ?></a></li>
        <?php } ?>

       <!--  <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("team_members/add_w2_form/" . $user_info->id); ?>" data-bs-target="#tab-w2-form"><?php echo app_lang('w2_form'); ?></a></li> -->
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade" id="tab-w2-form"></div>
        <div role="tabpanel" class="tab-pane fade" id="tab-appointments-info"></div>
    ...
    $(document).ready(function() {
        ...
        setTimeout(function() {
            ...
            if (tab === "general") {
                ...
                $("[data-bs-target='#tab-appointments-info']").trigger("click");
            }
        }, 210);
