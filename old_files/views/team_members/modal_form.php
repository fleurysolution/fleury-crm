    ...
    <div class="container-fluid">
        ...
        <div class="tab-content mt15">
            <div role="tabpanel" class="tab-pane active" id="general-info-tab">
                ...
                <div class="form-group">
                    <div class="row">
                        <label for="last_name" class=" col-md-3"><?php echo app_lang('permanent_city'); ?></label>
                        <div class=" col-md-9">
                            <?php
                            echo form_input(array(
                                "id" => "permanent_city",
                ...
                <div class="form-group">
                    <div class="row">
                        <label for="last_name" class=" col-md-3"><?php echo app_lang('state'); ?></label>
                        <div class=" col-md-9">
                            <?php
                            echo form_input(array(
                                "id" => "permanent_state",
                ...
                <div class="form-group">
                    <div class="row">
                        <label for="last_name" class=" col-md-3"><?php echo app_lang('zip'); ?></label>
                        <div class=" col-md-9">
                            <?php
                            echo form_input(array(
                ...
                <div class="form-group">
                    <div class="row">
                        <label for="last_name" class=" col-md-3"><?php echo app_lang('country'); ?></label>
                        <div class=" col-md-9">
                            <?php
                            echo form_input(array(
