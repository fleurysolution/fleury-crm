                ...
                <div id="page-content" class="clearfix">
                    <div style="max-width: 1000px; margin: auto;">
                        <div>
                                ...
                                <?php if ($is_estimate_editable) { ?>
                                    <div class="float-start mt20 ml15">
                                        <?php echo modal_anchor(get_uri("estimates/item_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_item'), array("class" => "btn btn-primary text-white add-item-btn", "title" => app_lang('add_item'), "data-post-estimate_id" => $estimate_info->id)); ?>
                                         ...
                                         <?php //echo modal_anchor(get_uri("estimates/material_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_material'), array("class" => "btn btn-primary text-white add-item-btn", "title" => app_lang('add_item'), "data-post-estimate_id" => $estimate_info->id)); ?>
                                    </div>
                                <?php } ?>
                            ...
                            <p class="b-t b-info pt10 m15 pb10"><?php echo custom_nl2br($estimate_info->note ? process_images_from_content($estimate_info->note) : ""); ?> 
                            </p>
