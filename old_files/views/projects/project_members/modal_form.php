...
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <input type="hidden" name="region_id" value="<?php echo $region_id.$project_info->region_id; ?>" />       
        <input type="hidden" name="office_id" value="<?php echo $project_info->office_id; ?>" />       
        <input type="hidden" name="division_id" value="<?php echo $project_info->division_id; ?>" />
...
<div class="modal-footer">
    ...
    <?php if ($view_type == "from_project_modal") { ?>
        ...
        <button type="button" id="save-and-milestone-button" class="btn btn-success">
            <span data-feather="flag" class="icon-16"></span> <?php echo app_lang('save_and_add_milestone'); ?>
        </button>
    <?php } else { ?>
...
<?php } ?>
              ...
              /*  if (window.showAddMultipleTasksModal) {
                 ...
                 if (window.showAddMultipleTasksModal) {
                        showAddMultipleTaskModal();
                    } else if (window.showAddMilestone) {
      ...
      /*  $("#save-and-continue-button").click(function () {
        ...
        $("#save-and-milestone-button").click(function () {
            window.showAddMilestone = true;
            $(this).trigger("submit");
        });
