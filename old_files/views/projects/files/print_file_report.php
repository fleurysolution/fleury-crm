<?php $this->Project_files_model = model('App\Models\Project_files_model'); 
...
/*      height: 220px;*/
    ...
    @media print {
      ...
      /* Fallback for browsers that don't support @page running headers */
      body::after {
...
<body>
  ...
  <div class="report-header">
    ...
    <div class="report-info">
      ...
      <p> <?php $project_data = $this->Projects_model->get_one($project_id[0]); 
     $Custom_fields= $this->Custom_fields_model->get_combined_details("projects", $project_id[0])->getResult(); echo $Custom_fields[0]->value; ?> </p>
    </div>
  </div>
  ...
  <div class="cards">
    ...
    <?php $i=0; foreach($checkbox_file as $checkedfiles){  
     ...
     ?>
      <!-- <?php echo 'Card '.$i; ?> -->
    <div class="card">
      <img src="<?php echo get_uri('files/project_files/'.$project_info->project_id.'/' . $project_info->file_name); ?>" alt="Image 1">
      <div class="description"><?php echo $project_info->description; ?></div>
      <div class="details">
...
<?php $i++; } ?>
    ...
    <!-- Add more cards here — automatically keeps 2 per row -->
  </div>
