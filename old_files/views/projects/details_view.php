...
if (!function_exists("make_project_tabs_data")) {
    ...
    function make_project_tabs_data($default_project_tabs = array(), $is_client = false)
    {
       ...
       // print_r($final_projects_tabs); die;
        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <ul id="project-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs rounded classic mb20 scrollable-tabs" role="tablist">
                        ...
                        if ($login_user->user_type === "staff") {
                            ...
                            $project_tabs = array(
                                ...
                                "assets" => "projects/assets/" . $project_info->id,
                                "returned_assets" => "projects/returned_assets/" . $project_info->id,
                            );
                            ?>
                            ...
                            if ($show_expense_info) {
                                $project_tabs["show_assets_info"] = "projects/assets/" . $project_info->id;
                                $project_tabs["show_return_assets_info"] = "projects/returned_assets/" . $project_info->id;
                            ...
                            $project_tabs["materials_area"] = "projects/areas/" . $project_info->id;
                            $project_tabs["show_assets_info"] = "projects/assets/" . $project_info->id;
                            $project_tabs["show_returned_assets_info"] = "projects/returned_assets/" . $project_info->id;
                            //print_r($project_tabs); die;
                           ...
                           if ($show_tasks) {
                            ...
                            if (get_setting("module_invoice") && $show_invoice_info) {
                                ...
                                if (!$left_menu || in_array("invoices", array_column($left_menu, "name"))) {
                                    ...
                                    $project_tabs["materials_area"] = "projects/materials_list/" . $project_info->id . "/" . $login_user->client_id;
                                    $project_tabs["show_assets_info"] = "projects/assets/" . $project_info->id;
                                    $project_tabs["show_return_assets_info"] = "projects/returned_assets/" . $project_info->id;
                        ...
                        ?>
                        <li class="nav-item" role="presentation"><a class="nav-link" data-bs-toggle="tab" href="<?php echo base_url()."projects/areas/".$project_info->id; ?>" data-bs-target="#project-areas-section" aria-selected="false" role="tab">Area</a></li>
                    </ul>
                </div>
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="project-assets-section"></div>                    
                    <div role="tabpanel" class="tab-pane fade" id="project-returned_assets-section"></div>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="project-areas-section"></div>
    ...
    $(document).ready(function() {
        setTimeout(function() {
            ...
            if (tab === "comment") {
                ...
                $("[data-bs-target='#project-assets-section']").trigger("click");
            }else if (tab === "returned_assets") {
                $("[data-bs-target='#project-returned_assets-section']").trigger("click");
            }
        }, 210);
