...
echo form_open(get_uri("projects/save"), array("id" => "project-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        <input type="hidden" name="id" value="<?php echo $model_info->id; ?>" />
        <input type="hidden" name="context" value="<?php echo $context; ?>" />
        <input type="hidden" name="context_id" value="<?php echo $context_id; ?>" />
        <input type="hidden" name="estimate_title" value="<?php echo $estimate_title; ?>" />
            ...
            <div class="row">
                ...
                <div class=" col-md-9">
                   ...
                   /* echo form_input(array(
                    ...
                    if(!empty($model_info->title)){ $title=$model_info->title; }else{ $title=$estimate_title; }
                    if(!empty($model_info->description)){ $model_description=$model_info->description; }else{ $model_description=$estimate_scope; }
                    if(!empty($model_info->price)){  $model_price=$model_info->price; }else{ $model_price=$estimate_total; }
            ...
            <div class="row">
                ...
                <div class=" col-md-9">
                    ...
                    echo form_textarea(array(
                        "id" => "description",
                        "name" => "description",
                        "value" => process_images_from_content($model_description, false),
                        "class" => "form-control",
                        "placeholder" => app_lang('description'),
                        "style" => "height:150px;",
                        "data-rich-text-editor" => true
