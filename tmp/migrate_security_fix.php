<?php
// Bootstrap CI4 from root
$rootDir = dirname(__DIR__);
define('FCPATH', $rootDir . '/public/');
require_once $rootDir . '/vendor/autoload.php';
$app = require_once $rootDir . '/vendor/codeigniter4/framework/system/bootstrap.php';
$app->initialize();

$db = \Config\Database::connect();
$forge = \Config\Database::forge();

echo "Bootstrapped CI4 successfully from $rootDir.\n";
